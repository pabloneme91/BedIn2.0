  ...
  render() {
    return (
      ...
      <div >
        ...
        <Link to="/" className="navbar-brand"><img src=".../.../public/logo_original.jpg" width="30" height="30" alt=""></img></Link>
        ...
        <div className="collapse navbar-collapse margenes" id="bs-example-navbar-collapse-1" id="navbar_bed">
          ...
          <ul className="nav navbar-nav navbar-right">
            ...
            <li className="dropdown">
              <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">USUARIO <span className="glyphicon glyphicon-chevron-down" aria-hidden="true"></span><span class="caret"></span></a>
